...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'Dashboard interactivo del clima con gráficos y pronósticos',
    image:
...
export const personalInfo = {
  name: 'Francis Pomasoncco Martinez',
  title: 'Full Stack Developer',
  description:
    'Desarrollador full stack enfocado en crear aplicaciones web optimizadas, escalables y con buenas prácticas de SEO.',
  email: 'francis11444@gmail.com',
  github: 'https://github.com/Francys999',
  linkedin: 'https://linkedin.com/in/tuusuario',
  siteUrl: 'https://tuportafolio.com',
  avatar:
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSrjywnLNB-hxfwctBu0AgfimAfwlxVpZHVow&s',
};
